...
We believe the systematic errors present in Method 1 did not affect Method 2 since we only used one polarizer angle and that angle was not near problematic angle range of $305\degree$--$340\degree$.  Our Verdet constant from Method 2 is thus the one to be reported as accurate as it was in agreement with the values reported by our colleagues.}
...
We can then determine whether they disagree due to the systematic error present in the first method resulting from a possibly defective polarizer, or if their disagreement is due to our rather large random errors primarily coming from angle setting.
