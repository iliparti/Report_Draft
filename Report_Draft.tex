...
\Delta \textrm{B}  & \textrm{Error~}\Delta \textrm{B} & \Delta \phi & \textrm{Error~}\Delta\phi ~(10^-5)       & \textrm{Reduced~} \chi^2    \\  \hline
...
{Systematic error in the latter part of the data.  Why- reading error?  Parallax?}
