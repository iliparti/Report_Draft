...
\begin{abstract}
{\textbf Conflicts, will fix tomorrow}
{The Faraday effect is a shift in the polarization of light as it passes through a medium subject to a magnetic field. We observed the Faraday effect in the following experiment. Polarized light from a 650 nm laser was sent through a SF-59 glass rod in a magnetic field produced by a solenoid. The light was then sent through a rotatable polarizer before it was detected by a photodiode.  We directly measured the voltage drop across a 1 K $\Omega$ resistor in series with the photodiode, a quantity directly proportional to light intensity.  Unwanted fluctuations in measured voltage due to fluctuations in light intensity due to variations in background room lighting were eliminated by modulating the laser output with a square wave and engaging a lock-in amplifier for phase-sensitive filtering of transmitted light.  The rotatable polarizer allows us to measure the shift in the polarization of the light caused by its passing through the rod.  We were able to measure the polarizer angle which enabled the generation of a maximum voltage (and thus maximum transmission of light intensity) for different values of magnetic field.  We aimed to calculate the Verdet constant for the rod by varying the magnetic fields and measuring the relative polarization shift and the voltage shift at a particular polarizer angle. From two separate calculations, we found a Verdet constant of $19.9 \pm 1.0 \mathrm{~rad/T} \cdot \textrm{m}$ and $17.54 \pm 1.12 \mathrm{~rad/T} \cdot \textrm{m}$. Other colleagues performing the experiment found the Verdet constant to be between 19 and 23$\mathrm{~rad/T} \cdot \textrm{m}$ from using the first method and between 19 and 21$\mathrm{~rad/T} \cdot \textrm{m}$ from using the second method.  In our paper, we address a possible systematic error that lead to our Verdet constant being too low from the second method.}


{The Faraday effect is a shift in the polarization of light as it passes through a medium subject to a magnetic field. We observed the Faraday effect in the following experiment. Polarized light from a 650 nm laser was sent through a SF-59 glass rod in a magnetic field produced by a solenoid. The light was then sent through a rotatable polarizer before it was detected by a photodiode. The light intensity detected by the photodiode is dependent on the relative polarizations of the light and the polarizer. {\textbf we seem to both be working on this, i'm sleeping now so i just fixed the conflict by inserting what i wrote in here. havent looked at your change}The rotatable polarizer was used to determine the shift in the polarization of the light from passing through the rod. We directly measured the voltage drop across a 1 K $\Omega$ resistor in series with the photodiode, a quantity proportional to light intensityThe rotatable polarizer allows us to measure the shift in the polarization of the light caused by its passing through the rod. We were able to compare the different output voltages from the photodiode (which are proportional to light intensity) measured for the same angle with varying values of magnetic field. We calculated the Verdet constant for the rod by varying the magnetic fields and measuring the relative polarization shift and the voltage shift at a particular polarizer angle. From two separate calculations, we found a Verdet constant of $19.9 \pm 1.0 \mathrm{~rad/T} \cdot \textrm{m}$ and $17.54 \pm 1.12 \mathrm{~rad/T} \cdot \textrm{m}$. Other colleagues performing the experiment found the Verdet constant to be between 19 and 23$\mathrm{~rad/T} \cdot \textrm{m}$ from using the first method and between 19 and 21$\mathrm{~rad/T} \cdot \textrm{m}$ from using the second method.  In our paper, we address a possible systematic error that lead to our Verdet constant being too low from the second method.
}
\end{abstract}
