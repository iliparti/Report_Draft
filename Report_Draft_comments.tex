...
\begin{enumerate}
  ...
  \item The relative roles of the rotatable polarizer, solenoid, and rod of birefringent glass aren't clear here. Add a sentence  or two describing how you used a second polarizer to determine the angle of polarization (or relative angle of polarization, or shift in polarization) of the light from the change in light intensity after it passed through the material.
